...
def append_df_to_excel(
        ...
        fmt_datetime: str = "yyyy-mm-dd hh:mm:ss",
    ...
    @param mode: arguments which will be passed to openpyxl for file writing mode`
                            [can be "a" or "w"]
    @return: None
    ...
    with pd.ExcelWriter(
        ...
        mode=mode if file_exists else "w",                  #pavel
        # if_sheet_exists="new" if file_exists else None,
        if_sheet_exists="new" if (file_exists and mode=="a") else None,
